...
<template>
  <div class="h-full w-full flex items-center flex-1 bg-base">
    <div class="flex-1 flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div class="max-w-md">
        <div class="text-5xl font-dark font-bold">{{ t("page.403.title") }}</div>
        <p class="text-2xl md:text-3xl font-light leading-normal">{{ t("page.403.head_title") }}</p>
        <p class="mt-2 mb-8">{{ t("page.403.second_title") }}</p>
